    ...
    , ui(new Ui::MainWindow)
{
    ...
    QAction* pasteDate = toolBar->addAction(tr("Paste datetime"));
    connect(pasteDate, SIGNAL(triggered()), this, SLOT(paste_datetime()));
...
void MainWindow::on_theme_currentTextChanged(const QString &arg1)
{
 ...
 void MainWindow::paste_datetime()
 {
    QTextEdit* textEdit = (QTextEdit*)ui->mdiArea->currentSubWindow()->widget();
    QDateTime date = QDateTime::currentDateTime();
    textEdit->textCursor().insertText(date.toString("hh:mm:ss.z dd.MM.yyyy"));
 }
